...
public class ShoppingCart implements Serializable {
    ...
    public Sales purchaseCart() throws PurchaseException {
        ...
        try {
            ...
            //ut.commit();
        } //catch (RollbackException | HeuristicMixedException | HeuristicRollbackException | NotSupportedException | SystemException | SQLException ex) {
        catch (SQLException ex) {
            logger.log(Level.INFO, "ShoppingCart: purchaseCart: {0}", ex);
